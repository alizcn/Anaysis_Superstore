...
os.chdir(r'C:\Users\Ali\PycharmProjects\Proje\Anaysis_superstore')
...
region = st.sidebar.multiselect("Pick our Region", df["Region"].unique())
if not region:
    df2 = df.copy()
else:
...
with col2:
    st.subheader("Region wise Salse")
